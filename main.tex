...
\usepackage{authoraftertitle} % for reciting author/title in the documents
...
\pagestyle{fancy}
\fancyhf{}
\lhead{Đồ án môn học - \csCompileTime}
...
\newcommand{\crname}{BÁO CÁO ĐỒ ÁN MÔN HỌC} % Thesis, report, whatever
\newcommand{\csCompileTime}{12/2019}

%----- SUB-SETTINGS FOR STUDENT NAMES -----%
\newcommand{\csSVone}{Rudo}
\newcommand{\csidSVone}{123456}
...
{\fontsize{24}{1}\selectfont \textbf{ỨNG DỤNG RFID MỞ KHÓA CỬA\\SỬ DỤNG EVALUATION KIT EK-TM4C123G}}\\[2.3cm]
\end{center}
